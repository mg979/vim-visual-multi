...
fun! vm#plugs#permanent()
  ...
  nnoremap        <Plug>(VM-Left-Mouse)              <LeftMouse>
  nmap            <Plug>(VM-Mouse-Cursor)            <Plug>(VM-Left-Mouse)<Plug>(VM-Add-Cursor-At-Pos)
  nmap            <Plug>(VM-Mouse-Word)              <Plug>(VM-Left-Mouse)<Plug>(VM-Find-Under)
...
fun! vm#plugs#buffer()
  ...
  nnoremap        <Plug>(VM-Filter-Regions)          :call vm#special#commands#filter_regions(0, '')<cr>
  ...
  "Edit commands
  nnoremap        <Plug>(VM-D)                       :<C-u>call vm#cursors#operation('d', 0, v:register, 'd$')<cr>
  nnoremap        <Plug>(VM-Y)                       :<C-u>call vm#cursors#operation('y', 0, v:register, 'y$')<cr>
  ...
  nnoremap        <Plug>(VM-C)                       :<C-u>call vm#cursors#operation('c', 0, v:register, 'c$')<cr>
