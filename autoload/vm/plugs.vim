...
fun! vm#plugs#buffer()
  ...
  nnoremap <silent>       <Plug>(VM-F3-Next)                 :call vm#commands#find_next(0, 1)<cr>
  nnoremap <silent>       <Plug>(VM-F2-Prev)                 :call vm#commands#find_prev(0, 1)<cr>
  ...
  nnoremap <silent>       <Plug>(VM-q-Skip)                  :call vm#commands#skip(0)<cr>
  ...
  nnoremap <silent>        <Plug>(VM-Dot)                     :call b:VM_Selection.Edit.dot()<cr>
